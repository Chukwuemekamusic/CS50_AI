...
class NimAI():
    ...
    def choose_action(self, state, epsilon=True):
        ...
        possible_actions, q_values = self.get_all_possible_actions_and_values(state)
